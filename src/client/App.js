...
class App extends React.Component {
  // Constructor, declaration of the state and variables
  constructor(){
    super();
    this.state = {
      from:"",
  ...
  // Translate text, request to api and response
  translateTxt(e){
   e.preventDefault();
   let textTranslated = document.getElementById('textTranslated');
    ...
    .then(res => res.json())
    .then(data => textTranslated.value = data.text );
  }
